...
@section('content')
    ...
    <main class='container-fluid mt-50'>
        <div class='row justify-content-center'>
            <div class='col-md-8'>
                <p class='text-left w-50 d-inline-block'>{{ $today }}</p><p class='float-right d-inline-block'>{{ $days_remaining == 1 ? $days_remaining . ' day ' : $days_remaining . ' days '  }}  left in month.</p>
            </div>
        </div>

<p class='progress-bar-label text-left' style='font-size: 20px'>Total Spending:</p><p class='progress-bar-label float-right' id='bar-label-right' style='font-size: 20px'>${{ round($data["actual"]) }} of ${{ $data["planned"] }}</p>
